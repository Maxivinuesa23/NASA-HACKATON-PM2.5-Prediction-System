...
// import { BarChart, Cpu, Rocket, Menu, X } from 'lucide-react';
...
const Navbar = () => {
  ...
  const handleNavClick = (e, item) => {
    // si es "Misión", hacemos scroll programático (evitamos problemas con fixed header)
    if (item.name === "Mission") {
      e.preventDefault();
      const el = document.getElementById("mision");
      if (el) {
        const headerOffset = 64; // px -> ajustalo si tu navbar no mide 64px
        ...
        // fallback: navegamos por hash si el elemento no existe aún
